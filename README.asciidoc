...
The plugin is still in version 0.1.3-SNAPSHOT, which works with Grails 3.1.x and Elasticsearch 5.5.2. Part of the scope of this new plugin is to simplify versioning and make it easier to upgrade.
